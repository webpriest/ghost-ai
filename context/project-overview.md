...
Ghost AI is a real-time collaborative system design workspace. Users describe a system in plain English, an AI maps that system onto a shared canvas, collaborators refine the architecture, and the app generates a technical specification from the resulting graph.

## Goals

1. Let authenticated users create and manage architecture projects.
2. Provice a collborative real-time canvas for system design.
3. Let users import rebuilt starter system designs into the canvas.
...
1. User signs in.
2. User creates and selects a project.
3. User enters the project workspace.
4. User optionally imports a starter design system into the canvas.
...
- A curated library of prebuilt system design template.
...
- Covers common patterns: monolithic, microservices, event-driven, serverless, and more.
